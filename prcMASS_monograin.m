...
% init
    ...
    % storage
    stArr_simresult(1:1, 1:sz_mat_graintype, 1:1, 1:1, 1:1, 1:1) =struct(...
        'initg1', struct(),...
        'initg2', struct(),...
        'val_corr', [],...
        'vsc', struct()...
    ...
    for ctr_d5 = 1 : 1 % loop for noise_level
        ...
        % fixed onto 12 fringes
            ...
            % fixed onto 18 steps
                ...
                % for mono grain g1_prop is constant 1 whose idx = 11
                    ...
                    for ctr_d2 = 1 : sz_mat_graintype % loop for graintype of g1
                        ...
                        for ctr_d2e = 1 : 1 % loop for graintype of g2
                            ...
                            stArr_simresult(ctr_d2e, ctr_d2, ctr_d3, ctr_d4e, ctr_d4, ctr_d5) = struct(...
                            'initg1', initg1,...
                            'initg2', initg2,...
                            'val_corr', val_corr...
                            );
                ...
                stArr_simresult(:, :, :, ctr_d4e, ctr_d4, ctr_d5) = struct(...
                    'vsc', vsc...
                );
            end
        end
